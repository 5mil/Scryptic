...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("strThirdPartyTxUrls")) {
        if(fTestNet)
            ...
            settings.setValue("strThirdPartyTxUrls", "https://bitinfocharts.com/Scryptic/tx/%s|https://coinplorer.com/STP/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/STP/tx/%s");
    }
    strThirdPartyTxUrls = settings.value("strThirdPartyTxUrls", "https://bitinfocharts.com/Scryptic/tx/%s|https://coinplorer.com/STP/Transactions/%s|https://explorer.novaco.in/tx/%s|https://bchain.info/STP/tx/%s").toString();
